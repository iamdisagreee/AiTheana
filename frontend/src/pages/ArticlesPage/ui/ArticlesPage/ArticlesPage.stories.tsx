...
const article = {
  ...
  img: "https://lifehacker.ru/wp-content/uploads/2025/01/milaya_kartinka_syurpriz_kotoraya_podnimaet_nastroenie_1735231354.png",
  views: 1022,
...
Primary.decorators = [
  StoreDecorator({
    articlesPage: { ids: ["1", "2"], entities: { "1": article } },
  }),
];
